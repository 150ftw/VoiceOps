      ...
      <section className="relative pt-24 pb-16 px-6 sm:px-12 max-w-6xl mx-auto flex flex-col items-center justify-center min-h-[75vh] text-center z-10 select-none">
        ...
        <div className="relative w-full max-w-5xl mx-auto flex items-center justify-center py-6 my-2 group cursor-pointer">
          ...
          <h1 className="relative z-10 text-6xl sm:text-8xl md:text-9xl lg:text-[10rem] font-glitch text-purple-100 uppercase drop-shadow-[0_0_60px_rgba(168,85,247,0.5)] scale-y-95 w-full flex flex-col items-center justify-center gap-1 sm:gap-2 select-none text-center">
            ...
            <span className="inline-block text-purple-200 tracking-[0.04em] group-hover:tracking-[0.22em] sm:group-hover:tracking-[0.32em] -mr-[0.04em] group-hover:-mr-[0.22em] sm:group-hover:-mr-[0.32em] transition-all duration-700 ease-out group-hover:text-purple-100 group-hover:drop-shadow-[0_0_80px_rgba(168,85,247,0.9)]">
              OPS
            </span>
          </h1>
        </div>
